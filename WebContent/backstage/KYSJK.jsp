...
<script src="../static/js/bootstrap/js/bootstrap-table-zh-CN.js"></script>
	...
	<script>
		<%
			...
			if(op == null || op == ""){
				op = "getAll";				
				url = "../controller/KYSJKController.jsp?op=getAll";
			}
			else if(op.equals("personal"))
				url = "../controller/KYSJKController.jsp?op=personal";
    ...
    <c:if test="${yh.getYHGROUP() == 0 || yh.getYHGROUP() == 1}">  
		...
		$("#btn_add").click(function () {			
			 ...
			 $('#table').bootstrapTable('insertRow', {
			      index: 0,
			      row: {rydm:defaultValue,xm:defaultValue,zc:defaultValue,lwdf:defaultValue,xmdf:defaultValue,
			    	  zzdf:defaultValue,zldf:defaultValue,dfhj:defaultValue,bzf:defaultValue,cefz:defaultValue,
			    	  kyjcfs:defaultValue,cejdf:defaultValue,kyjcjj:defaultValue,kycejj:defaultValue,
			    	  kyjlhj:defaultValue,nd:defaultValue
			      }
			 })
		})
		</script>
	    ...
	    $("#fileUpload").fileinput({  
	        language : "zh",//设置语言  
	        uploadUrl: "${pageContext.request.contextPath}/upLoadServlet?tableName=kysjk",//上传地址  
	        textEncoding: 'UTF-8',
	...
	$(function(){
		...
		window.operateEvents = {
			'click .save': function (e, value, row, index) {
				 ...
				 $.ajax({
	                    type: "post",
	                    url: "../controller/KYSJKController.jsp?op=update",
			...
			'click .delete': function (e, value, row, index) {
				...
				$.ajax({
	                 type: "post",
	                 url: "../controller/KYSJKController.jsp?op=delete",
	                 data: {"ID": row.id},
	                 dataType: 'JSON',
	                 success: function (data, status) {
	                     if (status == "success") {
