...
<script src="../static/js/bootstrap/js/bootstrap-table-zh-CN.js"></script>
	...
	<script>
		<%
			...
			if(op == null || op == ""){
				op = "getAll";				
				url = "../controller/GQRYController.jsp?op=getAll";
			}
			else if(op.equals("personal"))
				url = "../controller/GQRYController.jsp?op=personal";
		...
		<script>
			$("#btn_add").click(function () {
				 var index = $('#table').bootstrapTable().length;
			            ...
			            index: 0,
			            row: {rydm:'-',xm:'-',gw:'-',zgsjxs:'-',zcxs:'-',kqxs:'-',fpxs:'-',nzbzjj:'-',sfpjjl:'-',
			            	xxpyjl:'-',xypyjl:'-',xyhbt:'-',zjhdbt:'-',dypcfphj:'-',depcrjj:'-',kqkf:'-',bfhkc:'-',
			            	dspfphj:'-',hjje:'-'
			            }
			        })
			})
	...
	$(function(){
		...
		window.operateEvents = {
			...
			'click .delete': function (e, value, row, index) {
				...
				$.ajax({
	                 type: "post",
	                 url: "../controller/GQRYController.jsp?op=delete",
	                 data: {"ID": row.id},
	                 dataType: 'JSON',
	                 success: function (data, status) {
	                     if (status == "success") {
