...
<body>
	...
	<script>
		$("#btn_add").click(function () {
			 var index = $('#table').bootstrapTable().length;
		            ...
		            index: index,
		            row: {xh:'',rydm:'00000000',xm:'',bmmc:'',yfnzj:'0',grtzje:'0',nzjhj:'0',nzjks:'0',nzjsf:'0',sfzhm:'0',yhkh:'0',
		            	dhhm:'0',bz:'',qzqr:''
		            }
		        })
		})
    ...
    $("#fileUpload").fileinput({  
        language : "zh",//设置语言  
        uploadUrl: "${pageContext.request.contextPath}/upLoadServlet?tableName=zz",//上传地址  
        textEncoding: 'UTF-8',
	...
	<script>
		...
		function deleteByID(id) {
			...
			$.ajax({
				type:"post",//请求方式
				data:{"ID":id},
				url:"../controller/ZZController.jsp?op=delete",//请求地址
	...
	$(function(){
		...
		ajax : function (request) {
	        $.ajax({
	            type : "GET",
	            url : "../controller/ZZController.jsp",
			...
			columns: [{
			 ...
			 onEditableSave: function (field, row, oldValue, $el) {
				 //alert(row.gh);
	                $.ajax({
	                    type: "post",
	                    url: "../controller/ZZController.jsp?op=update",
