...
<body>
	...
	<div class="htmleaf-container" id="upLoad">
		...
		$("#btn_add").click(function () {
			 //var index = $('#table').bootstrapTable().length;
		            ...
		            index: 0,
		            row: {rydm:"-",xm:'',zdgzlhj:'0',gzlcj:'0',sqskksf:'0.00',pgzylc:'0.00',
		            	sqzbf:'0.00',hj:'0.00'}
		        })
		})
	</script>
    ...
    $("#fileUpload").fileinput({  
        language : "zh",//设置语言  
        uploadUrl: "${pageContext.request.contextPath}/upLoadServlet?tableName=mfsfsgzsjk",//上传地址  
