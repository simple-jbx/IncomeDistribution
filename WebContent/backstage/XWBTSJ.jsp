...
<body>
    ...
    $("#fileUpload").fileinput({  
        language : "zh",//设置语言  
        uploadUrl: "${pageContext.request.contextPath}/upLoadServlet?tableName=xwbtsj",//上传地址  
        textEncoding: 'UTF-8',
	...
	<script>
		...
		function deleteByID(id) {
			...
			$.ajax({
				type:"post",//请求方式
				data:{"ID":id},
				url:"../controller/SWBTSJController.jsp?op=delete",//请求地址
	...
	$(function(){
		...
		ajax : function (request) {
	        $.ajax({
	            type : "GET",
	            url : "../controller/XWBTSJController.jsp",
			...
			columns: [{
			 ...
			 onEditableSave: function (field, row, oldValue, $el) {
	                $.ajax({
	                    type: "post",
	                    url: "../controller/XWBTSJController.jsp?op=update",
