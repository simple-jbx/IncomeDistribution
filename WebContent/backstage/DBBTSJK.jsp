...
<script>
		<%
			...
			if(op == null || op == ""){
				op = "getAll";				
				url = "../controller/DBBTSJKController.jsp?op=getAll";
			}
			else if(op.equals("personal"))
				url = "../controller/DBBTSJKController.jsp?op=personal";
		...
		<!-- 设置上传相关参数 -->
   		<script>  
		    $("#fileUpload").fileinput({  
		        language : "zh",//设置语言  
		        uploadUrl: "${pageContext.request.contextPath}/upLoadServlet?tableName=ddbtsjk",//上传地址  
		        textEncoding: 'UTF-8',
		...
		ajax : function (request) {
			...
			window.operateEvents = {
					 'click .save': function (e, value, row, index) {
						 ...
						 $.ajax({
			                    type: "post",
			                    url: "../controller/DBBTSJKController.jsp?op=update",
			 ...
			 'click .delete': function (e, value, row, index) {
				 ...
				 $.ajax({
	                   type: "post",
	                   url: "../controller/DBBTSJKController.jsp?op=delete",
	                   data: {"ID": row.id},
	                   dataType: 'JSON',
	                   success: function (data, status) {
	                       if (status == "success") {
