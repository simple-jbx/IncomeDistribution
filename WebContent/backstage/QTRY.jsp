...
<script src="../static/js/bootstrap/js/bootstrap-table-zh-CN.js"></script>
	...
	<script>
		<%
			...
			if(op == null || op == ""){
				op = "getAll";				
				url = "../controller/QTRYController.jsp?op=getAll";
			}
			else if(op.equals("personal"))
				url = "../controller/QTRYController.jsp?op=personal";
		...
		<script>
			$("#btn_add").click(function () {
				...
				$('#table').bootstrapTable('insertRow', {
			        index: 0,
			        row: {rydm:defalutValue,xm:defalutValue,zgsjxs:defalutValue,khgzl:defalutValue,zgzlhj:defalutValue,
			        	cgzl:defalutValue,cgzljcj:defalutValue,jxdd:defalutValue,dypcjcj:defalutValue,msgzbf:defalutValue,
			        	ylbfhkcje:defalutValue,dspcfphj:defalutValue,sjzjcj:defalutValue,nd:defalutValue
			      	}
			    })
			})
		</script>
	...
	$(function(){
		...
		window.operateEvents = {
			'click .save': function (e, value, row, index) {
				 ...
				 $.ajax({
	                    type: "post",
	                    url: "../controller/QTRYController.jsp?op=update",
			...
			'click .delete': function (e, value, row, index) {
				...
				$.ajax({
	                 type: "post",
	                 url: "../controller/QTRYController.jsp?op=delete",
	                 data: {"ID": row.id},
	                 dataType: 'JSON',
	                 success: function (data, status) {
	                     if (status == "success") {
