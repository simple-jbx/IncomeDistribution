...
<body>
		...
		<script>
			$("#btn_add").click(function () {
				 var index = $('#table').bootstrapTable().length;
			            ...
			            index: 0,
			            row: {nd:'',xkjs:'0.00',dwjs:'0.00',kxyjw:'0.00',kxyjl:'0.00',rcpyzl:'0.00',
			            	rcpygm:'0.00',shsyyshfw:'0.00',fpjehj:'0.00',cskyje:'0.00',mfsfscj:'0.00',
			            	qtsr:'0.00',csjy:'0.00'
			            }
			        })
			})
	...
	$(function(){
		...
		ajax : function (request) {
	        $.ajax({
	            type : "GET",
	            url : "../controller/XYZHGLYFZPJFPJGBController.jsp?op=getAll",
			...
			window.operateEvents = {
					 'click .save': function (e, value, row, index) {
						 ...
						 $.ajax({
			                    type: "post",
			                    url: "../controller/XYZHGLYFZPJFPJGBController.jsp?op=update",
			 ...
			 'click .delete': function (e, value, row, index) {
				 ...
				 $.ajax({
	                   type: "post",
	                   url: "../controller/XYZHGLYFZPJFPJGBController.jsp?op=delete",
	                   data: {"ID": row.id},
	                   dataType: 'JSON',
	                   success: function (data, status) {
	                       if (status == "success") {
