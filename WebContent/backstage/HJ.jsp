...
<body>
	...
	<script>
		$("#btn_add").click(function () {
			 var index = $('#table').bootstrapTable().length;
		            ...
		            index: index,
		            row: {jlmc:'',cgmc:'',hjzz:'',zzpx:'',fzjg:'',hjrq:'',xxsm:'',hjjb:'',hjdj:'',dwpm:'',sftj:'',shzt:''}
		        })
		})
	</script>
	<script>  
    $("#fileUpload").fileinput({  
        language : "zh",//设置语言  
        uploadUrl: "${pageContext.request.contextPath}/upLoadServlet?tableName=hj",//上传地址  
        textEncoding: 'UTF-8',
	...
	<script>
		...
		function deleteByID(id) {
			...
			$.ajax({
				type:"post",//请求方式
				data:{"ID":id},
				url:"../controller/HJController.jsp?op=delete",//请求地址
	...
	$(function(){
		...
		ajax : function (request) {
	        $.ajax({
	            type : "GET",
	            url : "../controller/HJController.jsp",
			...
			columns: [{
			 ...
			 onEditableSave: function (field, row, oldValue, $el) {
	                $.ajax({
	                    type: "post",
	                    url: "../controller/HJController.jsp?op=update",
