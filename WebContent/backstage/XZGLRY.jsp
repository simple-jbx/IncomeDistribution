...
<script src="../static/js/bootstrap/js/bootstrap-table-zh-CN.js"></script>
	...
	<script>
		<%
			...
			if(op == null || op == ""){
				op = "getAll";				
				url = "../controller/XZGLRYController.jsp?op=getAll";
			}
			else if(op.equals("personal"))
				url = "../controller/XZGLRYController.jsp?op=personal";
    ...
    <c:if test="${yh.getYHGROUP() == 0 || yh.getYHGROUP() == 1}">  
		...
		$("#btn_add").click(function () {			
			 ...
			 $('#table').bootstrapTable('insertRow', {
			      index: 0,
			      row: {rydm:defaultValue,xm:defaultValue,zw:defaultValue,zj:defaultValue,
			    	  zgxs:defaultValue,zyxs:defaultValue,kqxs:defaultValue,fpxs:defaultValue,
					  xzpjj:defaultValue,xyrjj:defaultValue,bzxcgjl:defaultValue,jkgz:defaultValue,
					  ...
					  xwbt:defaultValue,jyshdjf:defaultValue,dypcjcj:defaultValue,depcjcj:defaultValue,
					  rjce:defaultValue,msgzcj:defaultValue,kqkf:defaultValue,msgzbf:defaultValue,
					  csbjsjfh:defaultValue,ylbfhkcje:defaultValue,dspcfphj:defaultValue,sjzjcj:defaultValue,
					  tzje:defaultValue,sjxyje:defaultValue,sfje:defaultValue,nd:defaultValue
			      }
			 })
		})
		</script>
	...
	$(function(){
		...
		window.operateEvents = {
			...
			'click .delete': function (e, value, row, index) {
				...
				$.ajax({
	                 type: "post",
	                 url: "../controller/XZGLRYController.jsp?op=delete",
	                 data: {"ID": row.id},
	                 dataType: 'JSON',
	                 success: function (data, status) {
	                     if (status == "success") {
