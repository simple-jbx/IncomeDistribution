...
<script src="../static/js/bootstrap/js/bootstrap-table-zh-CN.js"></script>
	...
	<script>
		<%
			...
			if(op == null || op == ""){
				op = "getAll";				
				url = "../controller/BDWJCJFFZBBController.jsp?op=getAll";
			}
			else if(op.equals("personal"))
				url = "../controller/BDWJCJFFZBBController.jsp?op=personal";
		...
		<script>
			$("#btn_add").click(function () {
				 ...
				 var index = $('#table').bootstrapTable().length;
			            ...
			            index: 0,
			            row: {bmdm:defaultValue,rydm:defaultValue,xm:defaultValue,bmmc:defaultValue,jx:defaultValue,
			            	xz:defaultValue,gq:defaultValue,qt:defaultValue,nzjje:defaultValue,cssl:defaultValue,nd:defaultValue
			            }
			        })
			})
		</script>
	...
	$(function(){
		...
		window.operateEvents = {
			...
			'click .delete': function (e, value, row, index) {
				...
				$.ajax({
	                 type: "post",
	                 url: "../controller/BDWJCJFFZBBController.jsp?op=delete",
	                 data: {"ID": row.id},
	                 dataType: 'JSON',
	                 success: function (data, status) {
	                     if (status == "success") {
