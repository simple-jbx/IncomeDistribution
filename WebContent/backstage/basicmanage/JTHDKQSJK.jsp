...
<body>
	...
	<script type="text/javascript">
		...
		var jsonGRSJ = null;
		var dataYear = 'All';
		var getURL = basePath+'/controller/JTHDKQSJKController.jsp';
		var upTableName = 'jthdkqsjk';
	</script>
	<script type="text/javascript" charset="UTF-8" src="${basePath}/static/js/backstage/other/JTHDKQSJK.js?v=2018081801"></script>	
	...
	<script type="text/javascript" charset="UTF-8" src="${basePath}/static/js/backstage/admin/JTHDKQSJKadmin.js?v=2018081801"></script>
</body>
</html>