...
<html>
 ...
 <body>     
    ...
    <div class="detail-page">
      ...
      <div class="detail-section">  
        <div class="row detail-row">
          <div class="span8">
            <label>指导工作量合计：</label><span id="zdgzlhj" class="detail-text"></span>
          </div>
          <div class="span8">
            <label>工作量酬金：</label><span id="gzlcj" class="detail-text"></span>
          </div>
          <div class="span8">
      ...
      <div class="detail-section">  
        <div class="row detail-row">
          <div class="span8">
            <label>暑期授课课时费：</label><span id="sqskksf" class="detail-text"></span>
          </div>
          <div class="span8">
            <label>批改作业劳酬：</label><span id="pgzylc" class="detail-text"></span>
          </div>
          <div class="span8">
            <label>暑期值班费：</label><span id="sqzbf" class="detail-text"></span>
          </div>
        </div>
      </div>
  ...
  function getDataByYear(year) {
	 $.ajax({
		 type : "post",
		 url : '../controller/MFSFSGZSJKController.jsp',
		 data : {
		 "op" : "personal",
		 "year" : year
		 },
		 ...
		 success : function(jsonData) {
			$("#zdgzlhj").text(jsonData[0].zdgzlhj);
			$("#gzlcj").text(jsonData[0].gzlcj);
			$("#sqskksf").text(jsonData[0].sqskksf);
			$("#pgzylc").text(jsonData[0].pgzylc);
			$("#sqzbf").text(jsonData[0].sqzbf);
